    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Monitor attendance records for your team members</p>
        </div>
      </div>
      ...
      <Card className="mb-6">
        <CardHeader className="pb-3">
          ...
          <CardDescription>Select a project to view team attendance records</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoadingProjects ? (
