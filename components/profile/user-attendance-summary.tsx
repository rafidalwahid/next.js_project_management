...
export function UserAttendanceSummary({ userId }: UserAttendanceSummaryProps) {
  ...
  const safeFormat = (dateString: string | null | undefined, formatString: string = "MMM d, yyyy") => {
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground flex items-center mt-1">
                          ...
                          {record.checkOutTime ? safeFormat(record.checkOutTime, " h:mm a") : " Present"}
                        </div>
                      ...
                      <div className="text-right">
                        <div className="font-medium">
                          {record.totalHours ? `${Number(record.totalHours).toFixed(1)} hrs` : "Active"}
                        </div>
                        {record.project && (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="border rounded-md p-4 text-center">
                  <div className="text-2xl font-bold">
                    {summary.lastCheckIn ?
                      safeFormat(summary.lastCheckIn, "MMM d") :
                      "N/A"}
                  </div>
