          ...
          <TooltipTrigger asChild>
            {currentAttendance && !currentAttendance.checkOutTime ? (
              ...
              >
                {checkingOut ? (
                  <>
                    <svg className="animate-spin h-4 w-4 mr-1 sm:mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  ...
                  <>
                    <LogOut className="mr-1 sm:mr-2 h-4 w-4 flex-shrink-0" />
              ...
              >
                {checkingIn ? (
                  ...
                  <>
                    <LogIn className="mr-1 sm:mr-2 h-4 w-4 flex-shrink-0" />
